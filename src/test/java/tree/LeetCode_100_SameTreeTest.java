...
public class LeetCode_100_SameTreeTest {
    ...
    public void test() {
        ...
        assertTrue(new LeetCode_100_Solution().isSameTree(node1, node2));
        ...
        assertTrue(new LeetCode_100_Solution().isSameTree(node11, node12));
        ...
        assertFalse(new LeetCode_100_Solution().isSameTree(node21, node22));
        ...
        assertFalse(new LeetCode_100_Solution().isSameTree(node31, node32));
